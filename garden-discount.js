(function(){
  ...
  function render(){
    ...
    if(!box){
      ...
      box.innerHTML='<strong>🌱 MMS Garden Club</strong><p style="margin:7px 0 10px;color:#62736b;font-size:14px">Have your Garden Club 10% discount code?</p><div style="display:flex;gap:8px;flex-wrap:wrap"><input id="garden-discount-code" type="text" placeholder="Enter GARDEN10" autocomplete="off" style="flex:1;min-width:180px;padding:10px;border:1px solid #cfd9d1;border-radius:9px;font:inherit;text-transform:uppercase"><button id="garden-discount-apply" type="button" class="btn">Apply 10% off</button></div><div id="garden-discount-status" style="margin-top:9px;font-weight:700;min-height:20px"></div>';
